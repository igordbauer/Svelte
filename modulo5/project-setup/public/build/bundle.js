...
var app = (function () {
    ...
    const file$3 = "src\\UI\\meetupItem.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*controlType*/ ctx[2] === "textarea") return create_if_block;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 76, 2, 2424);
    			add_location(main, file, 75, 0, 2415);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*email*/ 16) textinput3_changes.value = /*email*/ ctx[4];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const input_handler_3 = e => $$invalidate(4, email = e.target.value);
